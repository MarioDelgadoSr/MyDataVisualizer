							...
							toolbar: {	
								items:[	
									{ type: "menu-radio", id: "visual", tooltip: "Select Visual",
									  items: visualList.map (function (visual, index) { return { id: index, text: visual} }),
									  ...
									  selected: 0,  
									  text: function (item){
												return "Visual: " + item.items[item.selected].text;
											}
									},
									{type: 'break'},								
									{type: "button", id:"upload", tooltip: "Upload New Visual", text:"Upload"},	
									{type: 'break'},	
...
function fnShowMyDataVisualizerDemo(){
	...
	var visualIndex = w2ui.parentLayout.get("main").toolbar.items.find(function(item){return item.id == "visual"}).selected;
				...
				case "visual":		
					return		{
									items: [
										...
										{type: 'break'},	
										{type: 'check', id: 'axesHelper', checked: visualizer.axesHelper.obj.visible, text: "Axes", tooltip: "Show/Hide Axes on Visual"}, 
										{type: 'break'},					
										{type: 'color', id: 'background', color: visualizer.scene.obj.background.getHexString() , text: "Background", tooltip: "Set Background Color"}, 								
										{type: 'break'},										
										{type: 'check', id: 'boundingBox', checked: visualizer.boundingBox.obj.visible,  text: "Bounding Box", tooltip: "Set Bounding Box Properties"}, 	
										{type: 'color', id: 'bBoxColor', color: visualizer.boundingBox.obj.material.color.getHexString() , text: "Color", tooltip: "Set Background Color"}, 													
										{type: 'break'},
										...
										{type: 'break'},										
										{type: 'check', id: 'gridHelper', checked: visualizer.gridHelper.obj.visible, text: "Grid&nbsp;", tooltip: "Show/Hide Grid"},
