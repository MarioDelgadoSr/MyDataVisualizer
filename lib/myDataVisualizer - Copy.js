		...
		*/
		...
		function fnBuildScaleSlider(canvasParent, scaleTd, dataVisual) {
			...
			scaleSlider.addSlider({
				id: dataVisual.visualName + "_scaleSelector",
				...
				changed: function (v) {
					...
					if (timeOutVar)
						clearTimeout(timeOutVar); //timeOutVar is global, clear and reset to another timeOutInterval until user stops moving slider
